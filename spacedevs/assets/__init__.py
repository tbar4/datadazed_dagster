...
spacedevs_prod_data_assets = load_assets_from_package_module(package_module=prod, group_name=SPACEDEVS_DATA_PROD)
spacedevs_prod_news_assets = load_assets_from_package_module(package_module=prod, group_name=SPACEDEVS_NEWS_PROD)